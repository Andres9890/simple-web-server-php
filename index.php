    ...
    <body style="visibility: hidden;" ondragenter="dragEnter(event)" ondragover="dragOver(event)" ondragleave="dragLeave(event)" ondrop="dragDrop(event)">
        ...
        <div class="container full_container" id="settings_container">
            ...
            <div class="input_option">
                <div class="label">{lang.setting_language}<a href="https://github.com/terreng/simple-web-server/issues/200" target="_blank" onclick="window.api.openExternal(this.href);event.preventDefault()" style="float: right;color: var(--link-primary);font-weight: 500;font-size: 17px;">{lang.help_us_translate}</a></div>
        ...
        <div class="container" id="server_container">
            ...
            <div class="settings_section" inert>
                ...
                <div class="input_option">
                    ...
                    <textarea id="httpsCert" placeholder="" aria-label="{lang.option_httpsCert}"></textarea>
                </div>
                ...
                <div class="input_option">
                    ...
                    <textarea id="httpsKey" placeholder="" aria-label="{lang.option_httpsKey}"></textarea>
                </div>
